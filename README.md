...
Submitted by: **Esteban Padilla Cerdio**
...
* [x] The add button and field input are hidden, and are displayed when the user clicks on a floating button
...
## License
    ...
    Copyright [2001] [Esteban Padilla Cerdio]
